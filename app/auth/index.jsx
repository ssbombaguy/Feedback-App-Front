...
export default function Authentication() {
  ...
  const loginMutation = useMutation({
    mutationFn: (values) => authAPI.login(values.email, values.password, values.rememberMe),
  ...
  const handleLogin = (values) => { loginMutation.mutate({ ...values, rememberMe }) }
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        <View style={styles.container}>
          ...
          <Formik initialValues={{ email: '', password: '' }} validationSchema={AuthSchema} onSubmit={handleLogin}>
